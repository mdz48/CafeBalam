    ...
    void onClickBuscarButton(MouseEvent event) {
        if (!(datePicker.getValue() == null)) {
            if (datePicker2.getValue() == null) {
                ArrayList<VentaNacional> aux = App.getTienda().searchVentasNacionales(datePicker.getValue());
                if (!aux.isEmpty()) {
                ...
                ArrayList<VentaNacional> aux = App.getTienda().searchVentasNacionales(datePicker.getValue(), datePicker2.getValue());
                if (!aux.isEmpty()) {
